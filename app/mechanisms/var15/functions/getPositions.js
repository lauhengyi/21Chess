//Get a list of uncollided positions around the given position
function getPositions(position, occupiedMatrix) {
  ...
  return positions.filter((position) => !occupiedMatrix[position][0]);
}
