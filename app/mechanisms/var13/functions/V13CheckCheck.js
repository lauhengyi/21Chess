import V13CreatePieceDataCalculator from "../V13CreatePieceDataCalculator";

// Check whether a board is checked
function V13CheckCheck(board, occupiedMatrix, side) {
  //Get king's position
  let kingPos = null;
  ...
  for (let piece of board) {
    ...
    if (piece.side != side) {
      let pieceData = V13CreatePieceDataCalculator(
        piece,
        occupiedMatrix,
        board
      );
