import V13ExecuteMove from "./V13ExecuteMove.js";
import V13CheckCheck from "./V13CheckCheck.js";
import getPiece from "../../primaryFunctions/getPiece.js";
import V13GetChessMoves from "../V13GetChessMoves.js";
import clone from "just-clone";
import "react-native-console-time-polyfill";
import getOccupiedMatrix from "../../primaryFunctions/getOccupiedMatrix.js";

function V13ChessMovesReducer(state, action) {
  //Making deep copy
  ...
  switch (action.type) {
    ...
    case "makeTurn": {
      ...
      //Make move
      newDetails.boardLayout = V13ExecuteMove(
        action.move,
        state.boardLayout,
        action.castling
      );
    ...
    default:
      ...
      function updateChecks(occupiedMatrix) {
        if (state.currentSide) {
          if (V13CheckCheck(newDetails.boardLayout, occupiedMatrix, false)) {
            newDetails.checked = 2;
          } else {
            newDetails.checked = 0;
          }
        } else {
          if (V13CheckCheck(newDetails.boardLayout, occupiedMatrix, true)) {
...
export default V13ChessMovesReducer;
