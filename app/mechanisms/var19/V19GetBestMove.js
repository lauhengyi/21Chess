...
import V19EvaluateBoardV1 from "./V19EvaluatateBoardV1.js";
import V19EvaluateBoardV2 from "./V19EvaluatateBoardV2.js";
import clone from "just-clone";

function V19GetBestMove(
  gameDetails,
  getChessMoves,
  chessMovesReducer,
  difficulty
...
function getParameters(difficulty) {
  switch (difficulty) {
    case 0:
      return [1, V19EvaluateBoardV2];

    case 1:
      return [2, V19EvaluateBoardV1];

    case 2:
      return [2, V19EvaluateBoardV2];
  }
}
