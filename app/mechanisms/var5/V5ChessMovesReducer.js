import V5ExecuteMove from "./functions/V5ExecuteMove.js";
import V5CheckCheck from "./functions/V5CheckCheck.js";
import getPiece from "../primaryFunctions/getPiece.js";
import V5GetChessMoves from "./V5GetChessMoves.js";
import clone from "just-clone";
import "react-native-console-time-polyfill";
import getOccupiedMatrix from "../primaryFunctions/getOccupiedMatrix.js";

function V5ChessMovesReducer(state, action) {
  //Making deep copy
  ...
  switch (action.type) {
    ...
    case "makeTurn": {
      ...
      //Make move
      newDetails.boardLayout = V5ExecuteMove(
        action.move,
        state.boardLayout,
        action.castling
      );
    ...
    default:
      ...
      function updateChecks(occupiedMatrix) {
        if (state.currentSide) {
          if (V5CheckCheck(newDetails.boardLayout, occupiedMatrix, false)) {
            newDetails.checked = 2;
          } else {
            newDetails.checked = 0;
          }
        } else {
          if (V5CheckCheck(newDetails.boardLayout, occupiedMatrix, true)) {
...
export default V5ChessMovesReducer;
