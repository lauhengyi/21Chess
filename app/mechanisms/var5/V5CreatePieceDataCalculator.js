...
function V5CreatePieceDataCalculator(piece, occupiedMatrix) {
  switch (piece.type) {
    case "p":
...
class blankCalculator extends pieceDataCalculator {
  get moves() {
    return [];
  }
...
export default V5CreatePieceDataCalculator;
