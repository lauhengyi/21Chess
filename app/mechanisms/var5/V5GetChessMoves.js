import V5CheckPin from "./functions/V5CheckPin";
import V5CheckCheck from "./functions/V5CheckCheck.js";
...
import V5CreatePieceDataCalculator from "./V5CreatePieceDataCalculator.js";
import "react-native-console-time-polyfill";
import getOccupiedMatrix from "../primaryFunctions/getOccupiedMatrix.js";

function V5GetChessMoves(piece, board, occupiedMatrix, lastMoved, type) {
  switch (type) {
    case "moves":
...
function validAttacks(piece, occupiedMatrix) {
  // Get moveable moves
  let pieceData = V5CreatePieceDataCalculator(piece, occupiedMatrix);
...
function normalMoves(piece, board, occupiedMatrix) {
  ...
  for (let move of movesUnchecked) {
    if (V5CheckPin(move, board) === false) {
      moves.push(move);
    }
  }
  return moves;
...
function checkCastling(piece, board, occupiedMatrix, validMoves) {
  ...
  if (V5CheckCheck(board, occupiedMatrix, piece.side)) {
    return castleMoves;
  }
...
export default V5GetChessMoves;
