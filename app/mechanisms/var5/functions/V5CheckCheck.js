import V5CreatePieceDataCalculator from "../V5CreatePieceDataCalculator";

// Check whether a board is checked
function V5CheckCheck(board, occupiedMatrix, side) {
  //Get king's position
  let kingPos = null;
  ...
  for (let piece of board) {
    ...
    if (piece.side != side) {
      let pieceData = V5CreatePieceDataCalculator(piece, occupiedMatrix, board);
