import V12ExecuteMove from "./V12ExecuteMove.js";
import checkCheck from "../../var0/functions/checkCheck.js";
import getPiece from "../../primaryFunctions/getPiece.js";
import V10GetChessMoves from "../V12GetChessMoves.js";
import clone from "just-clone";
import "react-native-console-time-polyfill";
import getOccupiedMatrix from "../../primaryFunctions/getOccupiedMatrix.js";

function V12ChessMovesReducer(state, action) {
  //Making deep copy
  ...
  switch (action.type) {
    ...
    case "makeTurn": {
      ...
      //Make move
      newDetails.boardLayout = V12ExecuteMove(
        action.move,
        state.boardLayout,
        action.castling
      );
...
export default V12ChessMovesReducer;
