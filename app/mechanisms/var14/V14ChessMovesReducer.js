import V14ExecuteMove from "./functions/V14ExecuteMove.js";
import V14CheckCheck from "./functions/V14CheckCheck.js";
import getPiece from "../primaryFunctions/getPiece.js";
import V14GetChessMoves from "./V14GetChessMoves.js";
import clone from "just-clone";
import "react-native-console-time-polyfill";
import getOccupiedMatrix from "../primaryFunctions/getOccupiedMatrix.js";

function V14ChessMovesReducer(state, action) {
  //Making deep copy
  ...
  switch (action.type) {
    ...
    case "makeTurn": {
      ...
      //Make move
      newDetails.boardLayout = V14ExecuteMove(
        action.move,
        state.boardLayout,
        action.castling
      );
    ...
    default:
      ...
      function updateChecks(occupiedMatrix) {
        if (state.currentSide) {
          if (V14CheckCheck(newDetails.boardLayout, occupiedMatrix, false)) {
            newDetails.checked = 2;
          } else {
            newDetails.checked = 0;
          }
        } else {
          if (V14CheckCheck(newDetails.boardLayout, occupiedMatrix, true)) {
...
export default V14ChessMovesReducer;
