import V11ExecuteMove from "./V11ExecuteMove.js";
import V11CheckCheck from "./V11CheckCheck.js";
import getPiece from "../../primaryFunctions/getPiece.js";
import V11GetChessMoves from "../V11GetChessMoves.js";
import clone from "just-clone";
import getOccupiedMatrix from "../../primaryFunctions/getOccupiedMatrix.js";

function V11ChessMovesReducer(state, action) {
  //Making deep copy
  ...
  switch (action.type) {
    ...
    case "makeTurn": {
      ...
      //Make move
      newDetails.boardLayout = V11ExecuteMove(
        action.move,
        state.boardLayout,
        action.castling
      );
    ...
    default:
      ...
      function updateChecks(occupiedMatrix) {
        if (state.currentSide) {
          if (V11CheckCheck(newDetails.boardLayout, occupiedMatrix, false)) {
            newDetails.checked = 2;
          } else {
            newDetails.checked = 0;
          }
        } else {
          if (V11CheckCheck(newDetails.boardLayout, occupiedMatrix, true)) {
...
export default V11ChessMovesReducer;
