import checkPin from "./functions/V11CheckPin.js";
import checkCheck from "./functions/V11CheckCheck.js";
...
import V11CreatePieceDataCalculator from "./V11CreatePieceDataCalculator.js";
import getOccupiedMatrix from "../primaryFunctions/getOccupiedMatrix.js";

function V11GetChessMoves(piece, board, occupiedMatrix, lastMoved, type) {
  switch (type) {
    case "moves":
...
function validAttacks(piece, occupiedMatrix) {
  // Get moveable moves
  let pieceData = V11CreatePieceDataCalculator(piece, occupiedMatrix);
...
export default V11GetChessMoves;
