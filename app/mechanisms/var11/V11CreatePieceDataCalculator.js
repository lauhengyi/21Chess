...
function V11CreatePieceDataCalculator(piece, occupiedMatrix) {
  switch (piece.type) {
    case "p":
...
function accountCollidedPiece(position, piece, moves, occupiedMatrix, AorD) {
  const [collided, collidedSide, eatenId, eatenAge] = checkCollision(
    position,
    occupiedMatrix
  );
...
export default V11CreatePieceDataCalculator;
