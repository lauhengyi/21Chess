...
function V9CreatePieceDataCalculator(piece, occupiedMatrix, board) {
  ...
  if (piece.type === "k") {
    for (const otherPiece of board) {
      if (otherPiece.type === "q" && otherPiece.side === piece.side) {
        type = "q";
        break;
      }
    }
  ...
  switch (type) {
    case "p":
      return new pawnCalculator(newPiece, occupiedMatrix);
    case "r":
      return new rookCalculator(newPiece, occupiedMatrix);
    case "n":
      return new knightCalculator(newPiece, occupiedMatrix);
    case "b":
      return new bishopCalculator(newPiece, occupiedMatrix);
    case "q":
      return new queenCalculator(newPiece, occupiedMatrix);
    case "k":
      return new kingCalculator(newPiece, occupiedMatrix);
    default:
...
export default V9CreatePieceDataCalculator;
