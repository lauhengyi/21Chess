...
import V21EvaluateBoardV2 from "./V21EvaluatateBoardV2.js";
import V21EvaluateBoardV1 from "./V21EvaluatateBoardV1.js";
import clone from "just-clone";

function V21GetBestMove(
  gameDetails,
  getChessMoves,
  chessMovesReducer,
  difficulty
...
function getParameters(difficulty) {
  switch (difficulty) {
    case 0:
      return [1, V21EvaluateBoardV2];

    case 1:
      return [2, V21EvaluateBoardV1];

    case 2:
      return [2, V21EvaluateBoardV2];
  }
}
