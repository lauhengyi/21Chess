import V10ExecuteMove from "./functions/V10ExecuteMove.js";
import checkCheck from "../var0/functions/checkCheck.js";
import getPiece from "../primaryFunctions/getPiece.js";
import V10GetChessMoves from "./V10GetChessMoves.js";
import clone from "just-clone";
import "react-native-console-time-polyfill";
import getOccupiedMatrix from "../primaryFunctions/getOccupiedMatrix.js";

function V10ChessMovesReducer(state, action) {
  //Making deep copy
  ...
  switch (action.type) {
    ...
    case "makeTurn": {
      ...
      //Make move
      newDetails.boardLayout = V10ExecuteMove(
        action.move,
        state.boardLayout,
        action.castling
      );
...
export default V10ChessMovesReducer;
