...
function V6StatsBar(props) {
  ...
  function getHeaderText() {
    ...
    const opponentsName = options.mode ? "P" + opponent[0] : "Com";
    turnText =
    ...
    if (options.isAutoturn) {
      turnText = "P" + player[0] + "' s Turn";
    }

    //Add Over or Under depending on game
    const headerText = currentGame ? "Over: " + turnText : "Under: " + turnText;
